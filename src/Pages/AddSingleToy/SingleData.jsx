...
const SingleData = ({ toys }) => {
    // console.log(toys);
    const { image, carName, price, sellerName, availableQuantities, _id, description, ratings } = toys;


    const handlerAddToys = () => {
        const idDetails = {
            image,
            carName,
            price,
        ...
        <>
            ...
            <div data-aos="fade-left" className="card w-96 h-[500px] hover:shadow-2xl hover:duration-700 bg-base-100 shadow-xl p-5">
                ...
                <div className='flex justify-center gap-5'>
                    ...
                    <Link onClick={handlerAddToys} > <button className='btn text-white bg-[#1C3F3A]'>Add to my toys</button></Link>
                </div>
            </div>
